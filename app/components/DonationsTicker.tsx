...
function DonationMarqueeItem({ donation }: { donation: Donation }) {
  return (
    <span className="inline-flex shrink-0 items-center gap-2 px-4 text-sm font-medium text-violet-900">
      <Heart aria-hidden className="h-3.5 w-3.5 fill-violet-500 text-violet-500" />
...
export default function DonationsTicker() {
  ...
  return (
    <section
      ...
      className="border-b border-violet-100 bg-gradient-to-r from-violet-50 via-white to-amber-50"
    >
      ...
      {items.length > 0 && (
        <div className="donations-marquee overflow-hidden border-t border-violet-100/80 py-2">
